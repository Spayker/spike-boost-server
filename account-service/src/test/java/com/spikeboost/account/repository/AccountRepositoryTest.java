...
import com.spikeboost.account.util.factory.AccountFactory;
...
import static com.spikeboost.account.domain.Gender.FEMALE;
import static com.spikeboost.account.domain.Gender.MALE;
...
public class AccountRepositoryTest {
    ...
    private static Stream<Arguments> provideSameCreateDateAccountList() {
        ...
        List<Account> accountList = List.of(
                AccountFactory.createAccount("name1", "name1@gmail.com", createdDate, null, 25, MALE, 75, 173),
                AccountFactory.createAccount("name2", "name2@gmail.com", createdDate, null, 35, FEMALE, 48, 165));
        return Stream.of(Arguments.of(accountList));
    }
    ...
    private static Stream<Arguments> provideSameModifiedDateAccountList() {
        ...
        List<Account> accountList = List.of(
                AccountFactory.createAccount("name1", "name1@gmail.com", null, modifiedDate, 25, MALE, 75, 173),
                AccountFactory.createAccount("name2", "name2@gmail.com", null, modifiedDate, 35, FEMALE, 48, 165));
        return Stream.of(Arguments.of(accountList));
    }
    ...
    private static Stream<Arguments> provideSameAgeAccountList() {
        final int age = 35;
        List<Account> accountList = List.of(
                AccountFactory.createAccount("name1", "name1@gmail.com", new Date(), null, age, MALE, 75, 173),
                AccountFactory.createAccount("name2", "name2@gmail.com", new Date(), null, age, FEMALE, 48, 165));
        return Stream.of(Arguments.of(accountList));
    }
    ...
    private static Stream<Arguments> provideSameWeightAccountList() {
        final int weight = 75;
        List<Account> accountList = List.of(
                AccountFactory.createAccount("name1", "name1@gmail.com", new Date(), null, 25, MALE, weight, 173),
                AccountFactory.createAccount("name2", "name2@gmail.com", new Date(), null, 35, FEMALE, weight, 165));
        return Stream.of(Arguments.of(accountList));
    }
    ...
    private static Stream<Arguments> provideSameHeightAccountList() {
        ...
        List<Account> accountList = List.of(
                AccountFactory.createAccount("name1", "name1@gmail.com", new Date(), null, 25, MALE, 75, height),
                AccountFactory.createAccount("name2", "name2@gmail.com", new Date(), null, 35, FEMALE, 48, height));
        return Stream.of(Arguments.of(accountList));
    }
