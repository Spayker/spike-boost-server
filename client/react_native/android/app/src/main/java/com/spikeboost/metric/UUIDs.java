...
public class UUIDs {
    ...
    // Sensor section
    public static UUID SENSOR_SERVICE = UUID.fromString("0000fee0-0000-1000-8000-00805f9b34fb");
    public static UUID CHARACTER_SENSOR_CHARACTERISTIC = UUID.fromString("00000001-0000-3512-2118-0009af100700");
