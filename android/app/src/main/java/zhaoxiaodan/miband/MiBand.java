...
import zhaoxiaodan.miband.listeners.HeartRateNotifyListener;
import zhaoxiaodan.miband.listeners.NotifyListener;
import zhaoxiaodan.miband.listeners.RealtimeStepsNotifyListener;
import zhaoxiaodan.miband.model.BatteryInfo;
import zhaoxiaodan.miband.model.LedColor;
import zhaoxiaodan.miband.model.Profile;
import zhaoxiaodan.miband.model.Protocol;
import zhaoxiaodan.miband.model.UserInfo;
import zhaoxiaodan.miband.model.VibrationMode;
...
public class MiBand {
    ...
    /**
     * Pair device (broken for miband 3)
     *
     * @return data = null
     */
    ...
    /**
     * reads bluetooth signal level
     *
     * @param callback
     * @return data : int, rssi
     */
    ...
    /**
     * stops vibration for Protocol.VIBRATION_10_TIMES_WITH_LED
     */
    ...
    /**
     * Gravity sensor data notification monitor, Need to be used separately after setting
     * {@link MiBand#enableRealtimeStepsNotify} open and
     * {@link MiBand##disableRealtimeStepsNotify} close notification
     *
     * @param listener
     */
    public void setSensorDataNotifyListener(final NotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_MILI, Profile.UUID_CHAR_SENSOR_DATA, data -> listener.onNotify(data));
    }

    /**
     * Turn on gravity sensor data notification
     */
    ...
    /**
     * Turn off gravity sensor data notification
     */
    ...
    /**
     * Real-time step notification listener, Need to be used separately after setting
     * {@link MiBand#enableRealtimeStepsNotify} open and
     * {@link MiBand##disableRealtimeStepsNotify} close notification
     *
     * @param listener
    ...
    public void setRealtimeStepsNotifyListener(final RealtimeStepsNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_MILI, Profile.UUID_CHAR_REALTIME_STEPS, data -> {
    ...
    /**
     * Turn off real-time step notifications
     */
    ...
    public void setHeartRateScanListener(final HeartRateNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_HEART_RATE, Profile.UUID_NOTIFICATION_HEART_RATE, data -> {
            Log.d(TAG, Arrays.toString(data));
    ...
    public void startHeartRateScan() {
        ...
        MiBand.this.io.writeCharacteristic(Profile.UUID_SERVICE_HEART_RATE, Profile.UUID_CHAR_HEART_RATE, Protocol.START_HEART_RATE_SCAN, null);
    }
